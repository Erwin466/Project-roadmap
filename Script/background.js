class AnimatedBackground {
    ...
    createShootingStar() {
        ...
        shootingStar.animate([
            ...
            { transform: 'translateX(' + (window.innerWidth + 100) + 'px) translateY(-40px)', opacity: 0 }
        ], {
            duration: 2000,
            easing: 'ease-out'
        }).onfinish = () => {
    ...
    changeTheme(theme) {
        const themes = {
            space: 'linear-gradient(135deg, #0c0c0c 0%, #1a0033 25%, #000814 50%, #001d3d 75%, #003566 100%)',
            ocean: 'linear-gradient(135deg, #001845 0%, #002855 25%, #003566 50%, #0077b6 75%, #00b4d8 100%)',
            sunset: 'linear-gradient(135deg, #2d1b69 0%, #11998e 25%, #38ef7d 50%, #ffd89b 75%, #19547b 100%)',
            night: 'linear-gradient(135deg, #2c3e50 0%, #34495e 25%, #2c3e50 50%, #bdc3c7 75%, #2c3e50 100%)'
        };
